...
import { Home, Map, MessageSquareText } from "lucide-react";
        ...
        {items.map(({ href, label, icon: Icon, match }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "flex h-[58px] flex-col items-center justify-center gap-1 rounded-[20px] text-xs font-bold text-slate-500 transition active:scale-[0.98]",
